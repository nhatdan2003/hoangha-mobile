...
<body>
						...
						<div class="row d-flex ">
							...
							<div class="iteam-order col-xl-6  pt-2 text-center"
								...
								<span class="material-symbols-outlined"
									...
									href="/hoanghamobile/cartproduct"
	...
	<div class="menu-product pt-4" style="background-color: #f4f4f4;">
		...
		<div class="container mt-5"
			...
			<table class="giohang table table-hover">
				...
				<c:forEach var="item" items="${cart.items}">
					<form:form
						action="/hoanghamobile/cartproduct/update/${item.idProduct}"
						method="post">
						<tr style="font-size: 15px; font-weight: bold; color: #00483d;">
							<td><img alt="" src="../IMG/${item.image}"
							...
							<td><a
								href="/hoanghamobile/cartproduct/remove/${item.idProduct}">Remove</a></td>
						</tr>
					</form:form>
				</c:forEach>
				<tr>
				...
				<tr>
					...
					<td colspan="2"
						style="font-size: 15px; font-weight: bold; color: #bf1e2d"><fmt:formatNumber
							value="${cart.getAmount()}" type="currency" currencySymbol="VND" /></td>
		...
		<div class="container">
			<h2>Client Form</h2>
			<form:form modelAttribute="cilent" action="/hoanghamobile/cartproduct/dathang">
