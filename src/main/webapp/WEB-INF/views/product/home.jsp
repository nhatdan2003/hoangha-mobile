	...
	<div class="header mt-5" style="display: flex; margin-bottom: 10px;">
		...
		<ul class="flash-sale-nav">
			...
			<li><a href="" ng-click="setProductType('laptop')">Laptop/Màn
					Hình/Tivi</a></li>
			<li><a href="" ng-click="setProductType('phukien')">Đồng Hồ/
					Phụ Kiện</a></li>
		</ul>
		<div class="timer mt-4">
			<strong>1</strong> <strong>2</strong> <span>:</span> <strong>3</strong>
			<strong>4</strong> <span>:</span> <strong>5</strong> <strong>6</strong>
				...
				<div class="product"
					...
					<div class="row col-sm-12 text-center" style="margin-left: 10px;">
						<div class="sanpham col-sm-3 mt-5" style="margin-left: 0px;"
							ng-repeat="p in products | filter: {kind:productType}|limitTo:4">
							<a href="#!detail/{{p.id}}"><img src="{{p.image}}" alt=""
								width="110px"></a>
	...
	<div class="row text-center">
		<c:forEach var="product" items="${product}" varStatus="status">
			<c:if test="${status.count <= 10}">
				<div class="product-like">
					<div class="sp mt-4">
						<a href="#"><img src="${product.IMG}" alt="" class="img-fluid"></a>

					</div>
					<div class="product-name pt-2">${product.tenSP}</div>
					<div class="product-price pt-2">
						<strong>${product.price}</strong><strong>₫</strong>
...
<div class=" container pt-5 ">
	...
	<div class="row text-center">
		<div class="product-like"
			ng-repeat="p in products | filter: {kind : 'dienthoai'}">
			<div class="sp mt-4">
				<a href="#!detail/{{p.id}}"><img src="{{p.image}}" alt=""
					class="img-fluid"></a>
			...
			<div class="sale">
				<span class="bag" ng-if="p.km!=''">KM</span> <a> {{p.km}}</a> <strong
					ng-if=" p.km!='' ">VÀ 5 KM KHÁC</strong>
...
<div class="container pt-5">
	...
	<div class="row text-center">
		<div class="product-like "
			ng-repeat="p in products | filter: {kind : 'laptop'}">
			<div class="stiker">
...
<div class="container pt-5">
	...
	<div class="tintuc2 col-md-12">
		<div class="tintuc">
			...
			<p>
				<a href="">OnePlus 11R lộ ngoại hình ấn tượng qua hình ảnh rò rỉ
					mới nhất</a>
			</p>
		</div>
		<div class="tintuc">
		...
		<div class="tintuc">
			...
			<p>
				<a href="">Google đang “ấp ủ” công nghệ chuyển văn bản thành… âm
					nhạc</a>
			</p>
		</div>
	</div>
