                    ...
                    <div class="col-5 ">
                        <div class="product-center">
                            <p class="price current-product-price">
                                ...
                                <br>
                                <label class="text-dark" style="padding-top: 1rem">Sản phẩm Hiện Có :${item.qty}</label>
                            </p>
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<div class="row text-center">
						<c:forEach var="product" items="${itemRandom}" begin="14" end="19">
				...
				<div class="carousel-item">
					<div class="row text-center">
						<c:forEach var="product" items="${itemRandom}" begin="19" end="24">
							<div class="product-like"style="height: 340px; width: 200px">
								<div class="sp mt-3">
									<a href="<c:url value='/hoanghamobile/product?id=${product.idProduct}'/>"><img src="/IMG/${product.image}" alt=""
								class="img-fluid"></a>
				...
				<div class="carousel-item">
					<div class="row text-center">
						<c:forEach var="product" items="${itemRandom}" begin="24" end="29">
							<div class="product-like" style="height: 340px; width: 200px">
								<div class="sp mt-3">
									<a href="<c:url value='/hoanghamobile/product?id=${product.idProduct}'/>"><img src="/IMG/${product.image}" alt=""
								class="img-fluid"></a>
